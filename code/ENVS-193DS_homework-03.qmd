...
To create my affective visualization...

# Problem 3. Statistical critique

## a. Revisit and summarize

The main statistical test that the authors use in this paper to test their research question is a Chi-squared analysis. The authors are interested in seeing how different MPA characteristics impact the social well-being of fishing communities. Although I chose to describe the table in Homework 2, I will be critiquing the figure for this Homework, as it shows the results of the Chi-squared test.
